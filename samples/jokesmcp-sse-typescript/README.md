# 😁 Jokes MCP Server Sample (SSE version)
...
![😁 Jokes MCP Server Sample (SSE version)](https://m365-visitor-stats.azurewebsites.net/?resource=https://github.com/microsoft/copilot-studio-mcp/tree/main/samples/jokesmcp-sse-typescript&dot=)
